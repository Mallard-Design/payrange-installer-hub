...
<div style="margin-left: 20px; margin-bottom: 24px;">
    <p><strong>Continental Relay Harness Setup</strong></p>
    <a href="https://youtu.be/H-_A4c4_cqc" target="_blank">
        <img src="images/continental-relay-thumb.png"
             alt="Continental Relay Harness Setup Video"
             width="450"
             style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); cursor: pointer;">
    </a>
</div>